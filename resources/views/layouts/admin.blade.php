...
<body class="bg-gray-100 flex h-screen overflow-hidden font-sans">
    ...
    <main class="flex-1 min-w-0 overflow-y-auto flex flex-col bg-gray-100">
        ...
        <header
            class="px-16 bg-white border-b border-gray-200 py-4 flex justify-between items-center sticky top-0 z-10 shrink-0">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" @click.outside="open = false"
                    ...
                    <span
                        class="text-sm text-gray-500 hidden sm:block group-hover:text-gray-700 transition">Administrator</span>
                    <div
