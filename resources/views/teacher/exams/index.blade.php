                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-8 py-5 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <div class="flex justify-end items-center space-x-2">
                                        ...
                                        <button 
                                            type="button" 
                                            @click="$dispatch('open-delete-modal', { action: '{{ route('teacher.exams.destroy', $exam->id) }}', title: 'Archive Exam', message: 'Are you sure you want to archive this exam? Students will no longer be able to access it.' })"
                                            class="flex items-center m-0"
                                        >
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center bg-gray-50 text-gray-400 group-hover:bg-red-50 group-hover:text-red-600 transition-colors">
